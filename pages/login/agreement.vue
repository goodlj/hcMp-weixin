<template>
	<view class="myOne">
		<view class="my-div">
			<view class="agreeHeader">海川小海智链用户协议</view>
			<view class="updateTime">
				<text>更新日期：2025年5月20日</text>
				<text>失效日期：2025年5月20日</text>
			</view>
			<view class="agreementStatement">
				<view>
					欢迎使用海川小海智链小程序(以下简称 “本小程序”)！
				</view>
				<!-- <view>本小程序由陕西小海智链科技有限公司（以下简称 “我们”或“本公司”）开发和运营。</view> -->
				<view>本小程序由陕西海川医药有限公司（以下简称 “我们”或“本公司”）开发和运营。</view>
			</view>
			<view>
				<view class="agreeTitle">
					一、接受条款
				</view>
				<view>
					<view class="agreementStatement">
			...
			<view>
				...
				<view>
					<view>
						1、用户应当同意本协议的全部条款并按照页面提示完成全部注册程序(未成年人应与法定监护人共同完成)。用户在注册过程中点击我已阅读并同意《用户协议》和《隐私政策》按钮即表示完全接受本协议全部条款。
					</view>
					<view>
						2、用户在使用本小程序前需要注册一个本产品账号。本产品账号应当使用微信号绑定注册，请用户使用尚未与本产品账号绑定且未被本产品根据本协议封禁的手机号码注册账号。本产品可以根据用户需求或产品需求对账号注册和绑定的方式进行更改，而无须事先通知用户。
					</view>
					<view>
						3、用户在使用本产品服务过程中应保证各项服务业务所需信息的真实性，如果因信息不真实而引起的问题，以及问题发生所带来的后果，本公司不负任何责任。
					</view>
					<view>
						4、在用户注册及使用本产品时，要搜集能识别用户身份的个人信息以便系统可以在必要时联系用户，或为用户提供更好的使用体验。系统搜集的信息包括但不限于用户的头像、昵称、单位名称、单位性质、手机号、性别、年龄、出生日期、所在城市；系统同意对这些信息的使用将受限于用户个人隐私信息保护的约束。
					</view>
				</view>
			</view>
			...
			<view>
				...
				<view>
					<view>
						1、本小程序的具体内容由本产品根据实际情况提供，包括但不限于用户使用本产品等。本产品可以对提供的服务予以变更，且本产品提供的服务内容可能随时变更，用户将会收到关于服务变更的通知。
					</view>
					<view>
			...
			<view>
				...
				<view>
					1、依据法律的规定，我们将在特定情形下收集、使用和披露您的个人信息。以下条款描述了我们如何收集、使用和披露您的个人信息。你可以在本小程序中查阅<text class="privacyColor"
						@click="gotoPrivacy">《隐私政策》</text>的具体内容。
				</view>
			</view>
			<view>
				2、信息收集
			...
			<view>
				...
				<view>
					(1)用户提供
					我们会对您直接提供的信息进行保存。比如：我们会记录您的注册信息、寻求客服或者其他和我们沟通的记录。记录信息的种类包括：头像、昵称、姓名、手机号、单位名称、单位性质、性别、出生日期、所在地区以及其他您选择提供的信息。我们收集、使用和披露个人信息是为了通过创建账户、识别用户、回应查询和邮件等方式来为您提供服务。
			...
			<view>
				6、未成年人隐私保护
				<view>
					我公司重视对未成年人个人隐私信息的保护。我公司将依赖用户提供的个人信息判断用户是否为未成年人。任何18岁以下的未成年人注册账号或使用本小程序应事先取得家长或其法定监护人(以下简称“监护人”)的书面同意。除根据法律法规的规定及有权机关的指示披露外，我公司不会使用向任何第三方透露未成年人的个人隐私信息。
				</view>
			...
			<view>
				...
				<view>
					<view>
						1、本项规范所述内容是指用户使用本小程序过程中所制作、上载、复制、发布、传播的任何内容，包括但不限于账号头像、名称、个性签名等注册信息及认证资料，或文字、语音、图片、图文等发送、回复消息和相关链接页面，以及其他使用本产品账号或本小程序所产生的内容。
					</view>
					<view>
					...
					<view>
						3、用户不得利用本产品账号或本小程序制作、上载、复制、发布、传播下干扰本产品正常运营，以及侵犯其他用户或第三方合作权益的内容：

						(1)含有任何性暗示的；
						(2)含有辱骂、恐吓、威胁内容的；
						(3)含有骚扰、垃圾广告、恶意信息、诱骗信息的；
						(4)涉及他人隐私、个人信息或资料的；
						(5)含有其他干扰本小程序正常运营和侵犯其他用户或第三方合法权益的。
					</view>
				</view>
			</view>
			...
			<view>
				...
				<view>
					<view>
						1、用户在本小程序中或通过本小程序所传送、发布的任何内容并不反映或代表，也不得被视为反映或代表我公司的观点、立场或政策，我公司对此不承担任何责任。
					</view>
					<view>
					...
					<view>
						3、用户须对利用本产品账号或本小程序传送信息的真实性、合法性、无害性、准确性、有效性等全权负责，与用户所传播信息相关的任何法律责任由用户自行承担，与我公司无关。如因此给我公司或第三方造成损害的，用户应当依法予以赔偿。
					</view>
					<view>
			...
			<view>
				...
				<view>
					<view>
						1、本协议自你使用本小程序之日起生效，直至你注销账户或我们终止服务为止。
					</view>
					<view>
						2、本协议中的标题仅为方便而设，在解释本协议时应被忽略。
					</view>
					<view>
						3、本协议及其修改权、最终解释权归我公司所有。
					</view>
				</view>
			</view>
		</view>
